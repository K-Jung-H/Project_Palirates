...
void CCamera::CreateShaderVariables(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	HRESULT hr = m_pd3dcbCamera->Map(0, NULL, (void**)&m_pcbMappedCamera);
	if (FAILED(hr))
	{
		return;
	}
	...
	if (!m_pd3dcb_Prev_Camera)
	{
		return;
	}
	HRESULT hr2 = m_pd3dcb_Prev_Camera->Map(0, NULL, (void**)&m_pcbMapped_Prev_Camera);
	if (FAILED(hr2))
	{
		return;
	}
