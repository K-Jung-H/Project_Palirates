...
#define ROOT_PARAMETER_G_BUFFER_SRV_INDEX 3
#define ROOT_PARAMETER_MATERIAL_REFLECTANCE_INFO_SRV_INDEX 4
#define ROOT_PARAMETER_FOG_NOISE_TEXTURE_SRV_INDEX 5
