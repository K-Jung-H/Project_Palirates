...
#define ROOT_PARAMETER_Object_X_RAY_TEXTURE_SRV_INDEX 8

//=====================================
#define ROOT_PARAMETER_TRANSPARENT_FRAME_BUFFER_INDEX 0
#define ROOT_PARAMETER_TRANSPARENT_GAMEOBJECT_TRANSFORM_INDEX 1
#define ROOT_PARAMETER_TRANSPARENT_CAMERA_CBV_INDEX 2
#define ROOT_PARAMETER_TRANSPARENT_SPRITE_INFO_INDEX 3
#define ROOT_PARAMETER_TRANSPARENT_ALBEDO_TEXTURE_INDEX 4
