...
enum AnimationTrack {
    ...
    TRACK_GARGOYLE_IDLE = 0,
    TRACK_GARGOYLE_IDLE_BREAK = 1,
    TRACK_GARGOYLE_WALK = 2,
    TRACK_GARGOYLE_WALK_BACK = 3,
    TRACK_GARGOYLE_GET_HIT = 4,
    TRACK_GARGOYLE_DEAD = 5,
    TRACK_GARGOYLE_ATTACK1 = 6,
    TRACK_GARGOYLE_SKILL_1 = 7,
    TRACK_GARGOYLE_SKILL_2 = 8,
    TRACK_GARGOYLE_SKILL_3 = 9,

    TRACK_CREATURE1_IDLE = 0,
    TRACK_CREATURE1_ATTACK1 = 1,
    TRACK_CREATURE1_ATTACK2 = 2,
    TRACK_CREATURE1_GET_HIT = 3,
    TRACK_CREATURE1_WALK = 4,
    TRACK_CREATURE1_DEAD = 5
};