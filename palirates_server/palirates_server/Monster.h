...
public:  
    ...
    static const int MONSTER_FISHMAN = static_cast<int>(Monster_Type::Fishman);  
    static const int MONSTER_ANUBIS = static_cast<int>(Monster_Type::Anubis);  
    static const int MONSTER_DRAGON = static_cast<int>(Monster_Type::Dragon);  
    Monster_Type type;  
    ...
    std::string Serialize() const // Add 'const' qualifier to make the method compatible with constant objects  
    {  
